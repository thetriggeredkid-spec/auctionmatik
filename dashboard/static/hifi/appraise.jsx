...
function AppraiseView({ mode, profile }) {
  ...
  function run() {
    ...
    const params = new URLSearchParams({ ...f, mode: mode === "triage" ? "triage" : "deep", profile });
  ...
  return (
    <div className="shell" style={{ paddingTop: 26 }}>
      ...
      <div className="faint rise" style={{ fontSize: 12, marginBottom: 20, maxWidth: 720, lineHeight: 1.55 }}>
        Enter a vehicle (or paste a VIN to autofill), set the seller type and asking price, and run the
        same deep appraisal used for Regal lots — comps, vision, VMR and the AI brain — with the
        private/dealer economics for your active location (set in Settings).
      </div>
